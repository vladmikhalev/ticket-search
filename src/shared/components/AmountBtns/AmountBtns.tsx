...
export function AmountBtns({id, setIsModalOpen}: IPropsAmountBtns) {
  ...
  return (
    <div className={styles.amountBtns}>
      <button className={styles.btnDecrease} data-disabled={isDisableBtnDecrease} onClick={handleDecrease}>
      ...
      <button className={styles.btnIncrease} data-disabled={isDisableBtnIncrease} onClick={handleIncrease}>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="20" height="20" rx="4" fill="#FF5500" />
